...
def parse_args():
    ...
    parser.add_argument('--label-width', dest='label_width', type=int, default=50,
    ...
    parser.add_argument('--num-class', dest='num_class', type=int, default=2,
                        help='number of classes')
    parser.add_argument('--num-example', dest='num_example', type=int, default=80000,
