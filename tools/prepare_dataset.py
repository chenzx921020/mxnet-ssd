...
def load_pascal(image_set, devkit_path, shuffle=False):
    """
    ...
    s='train'
    imdbs.append(PascalVoc(s, devkit_path, shuffle, is_train=True))
    if len(imdbs) > 1:
...
if __name__ == '__main__':
    ...
    if args.dataset == 'pascal':
        db = load_pascal(args.set, args.root_path, args.shuffle)
